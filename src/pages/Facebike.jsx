  ...
  return (
    <div className="about-container">
      ...
      <div className="gallery-info">
        ...
        As seções do site foram organizadas para refletir diferentes momentos e companhias ao longo dos anos. Em Viagens (página anteior), estão os relatos das aventuras marcantes, aqueles <em>grandes périplos</em> que reúnem-se jornadas que exigiram planejamento, e grande dose de espírito explora(dor).
      ...
      {/* Linha Suave */}
      <hr className="divider" />
      <div className="gallery-info"><h2 className="gallery-title">Gotas de Lembranças</h2></div>
