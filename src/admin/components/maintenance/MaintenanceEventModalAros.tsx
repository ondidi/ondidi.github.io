...
interface MaintenanceEventModalArosProps {
  componentName: string;
  cycleId: string;
  onClose: () => void;
}

export default function MaintenanceEventModalAros({
  componentName,
  cycleId,
  onClose,
}: MaintenanceEventModalArosProps) {
  const [eventType, setEventType] = useState<
    "inspection" | "alignment" | "repair" | "replacement"
  >("inspection");
    ...
    <div className="maintenance-modal-overlay">
      <div className="maintenance-modal">
        ...
        <div className="maintenance-form">
          ...
          {eventType === "inspection" && (
            <div className="maintenance-form-field">
              <label htmlFor="inspection-result-aros">
                Resultado da inspeção
              </label>

              <select
                id="inspection-result-aros"
